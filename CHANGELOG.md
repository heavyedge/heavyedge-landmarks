...
- `plateau_type2()` no longer forces nonnegative slope.
- `plateau_type3()` no longer forces nonpositive slope.

## [1.4.0] - 2025-11-22

### Added

- `landmarks_type1()` function to locate mathematical landmarks from type 1 profiles.
